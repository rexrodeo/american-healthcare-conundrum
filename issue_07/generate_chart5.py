"""
The American Healthcare Conundrum — Savings Tracker v8 (Issue #7)
Seven issues: OTC drugs, drug pricing, hospital pricing, PBMs, admin waste, supply waste, GLP-1 pricing.
Total: $396.6B = 13.2% of $3T gap.
Cloned from issue_06/generate_chart6.py — added Issue #7 line only.
"""
import matplotlib
matplotlib.use('Agg')
...
OUT_CHART5  = str(_PROJECT_ROOT / 'issue_07' / 'figures' / 'chart5_savings_tracker.png')
...
FILLS      = [BLUE_DARK, BLUE, RED, TEAL, PURPLE, ORANGE, EMERALD]
LABEL_COLS = [BLUE_DARK, BLUE_DARK, RED_DARK, TEAL_DARK, PURPLE_DK, ORANGE_DK, EMERALD_DK]

# ── Derived numbers ──────────────────────────────────────────────────────────
TARGET_B   = TARGET_TRILLIONS * 1000

ZOOM_B = 500.0   # $500B zoom window for 6-issue view
...
fig.text(0.50, 0.01,
         ...
         'Issue #7: GLP-1 pricing ($40.0B)  |  Savings are non-overlapping; conservative estimates.',
         ha='center', va='bottom', fontsize=6.5, color=MID, style='italic')
