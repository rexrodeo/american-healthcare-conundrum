"""
The American Healthcare Conundrum — Savings Tracker v6 (Issue #5)
Five issues: OTC drugs, drug pricing, hospital pricing, PBMs, admin waste.
Total: $328.6B = 11.0% of $3T gap.
Matches established tracker style from Issue #4 (light background, context bar + zoom).
"""
import matplotlib
matplotlib.use('Agg')
...
OUT_CHART6  = str(_PROJECT_ROOT / 'issue_05' / 'figures' / 'chart6_savings_tracker.png')
...
FILLS      = [BLUE_DARK, BLUE, RED, TEAL, PURPLE]
LABEL_COLS = [BLUE_DARK, BLUE_DARK, RED_DARK, TEAL_DARK, PURPLE_DK]

# ── Derived numbers ──────────────────────────────────────────────────────────
TARGET_B   = TARGET_TRILLIONS * 1000
cumulative = sum(i["savings_billions"] for i in ISSUES)

ZOOM_B = 400.0   # $400B zoom window for 5-issue view (up from $200B)
...
# ════════════════════════════════════════════════════════════════════
# PANEL B — Zoomed bar ($400B window)
# ════════════════════════════════════════════════════════════════════
...
fig.text(0.50, 0.01,
         ...
         'Issue #5: Admin waste reduction ($200.0B) \u00b7  '
