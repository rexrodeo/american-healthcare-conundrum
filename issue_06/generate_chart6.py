"""
The American Healthcare Conundrum — Savings Tracker v7 (Issue #6)
Six issues: OTC drugs, drug pricing, hospital pricing, PBMs, admin waste, supply waste.
Total: $356.6B = 11.9% of $3T gap.
Matches established tracker style from Issues #4-5 (light background, context bar + zoom).
"""
import matplotlib
matplotlib.use('Agg')
...
OUT_CHART6  = str(_PROJECT_ROOT / 'issue_06' / 'figures' / 'chart6_savings_tracker.png')
...
FILLS      = [BLUE_DARK, BLUE, RED, TEAL, PURPLE, ORANGE]
LABEL_COLS = [BLUE_DARK, BLUE_DARK, RED_DARK, TEAL_DARK, PURPLE_DK, ORANGE_DK]
...
# ── Save ─────────────────────────────────────────────────────────────────────
for out_path in [OUT_TRACKER, OUT_CHART6]:
